...
## Weekly Focus
Strings continued; Coding Odyssey checkpoint 1 (first applied-project pass). See `lessons/06-strings.md` and `assignments/A2-coding-odyssey-project.md`.
...
## Due this week
Coding Odyssey checkpoint 1 (`assignments/A2-coding-odyssey-project.md`).
