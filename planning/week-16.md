...
## Weekly Focus
Coding Odyssey checkpoint 3 (final creative project pass); professional reflection artifacts — unofficial transcript, advisor/progress check, degree plan, resume, dream-job research, LinkedIn/GitHub. See `lessons/09-projects-tools-and-reflection.md` and `assignments/professional-pathway-artifacts.md`.
...
## Due this week
Coding Odyssey checkpoint 3 (`assignments/coding-odyssey-project.md`); professional pathway artifacts (`assignments/professional-pathway-artifacts.md`).
