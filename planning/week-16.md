...
— it's staged across the semester (Week 1 baseline, Week 14 update, Week 15
...
## Due this week
Farkle/ML applied session participation — no Coding Odyssey checkpoint or
gate is due this week (retired; see above). Start of final reflection
(`assignments/A5-final-reflection.md`). The professional-pathway artifact
set (`assignments/A6-professional-pathway-artifacts.md`) is **not** due
this week — it was submitted in Week 15.
